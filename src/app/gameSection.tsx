        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    ...
                    >
                        <Image
                            source={item.coverImg ? { uri: item.coverImg } : require("@/src/assets/game-capes/placeholder.jpg")}
                            style={styles.cover}
                        />
            ...
            {/* New Game Button */}
            <Pressable
                style={[styles.newGameButton, { borderColor: STATUS_COLORS[categoryKey], marginBottom: insets.bottom }]}
